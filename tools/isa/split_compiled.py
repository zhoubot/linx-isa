...
def main() -> int:
    ...
    ap.add_argument("--spec", default="isa/spec/current/linxisa-v0.2.json", help="Compiled spec JSON path")
    ap.add_argument("--out", default="isa/golden/v0.2", help="Golden output directory")
    args = ap.parse_args()
