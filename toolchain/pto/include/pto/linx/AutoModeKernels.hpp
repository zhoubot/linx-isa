...
__attribute__((noinline)) inline void gemm_kernel_i32(const int32_t *a, const int32_t *b, int32_t *out) {
...
__attribute__((noinline)) inline void flash_attention_kernel_i32(const int32_t *q, const int32_t *k,
