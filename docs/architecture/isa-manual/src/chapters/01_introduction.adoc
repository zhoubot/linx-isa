...
This manual describes the programmer-visible interface of the Linx ISA as captured in the v0.2 draft catalog used by
this repository (see <<preamble>>). It is not a microarchitecture document.

[[intro-goals]]
=== Design goals (v0.2 bring-up)

The v0.2 catalog and toolchain bring-up emphasize:
